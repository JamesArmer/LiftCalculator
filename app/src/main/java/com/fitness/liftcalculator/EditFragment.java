...
public class EditFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        liftCategoryRecyclerView = getView().findViewById(R.id.liftCategoryRecyclerView2);
        emptyImage = getView().findViewById(R.id.emptyImageView2);
        emptyText = getView().findViewById(R.id.emptyTextView2);
        addButton = getView().findViewById(R.id.addButton2);
        ...
        customAdapterCategory = new CustomAdapterCategory(getActivity(), getActivity(), lift_id, lift_category, 1);
